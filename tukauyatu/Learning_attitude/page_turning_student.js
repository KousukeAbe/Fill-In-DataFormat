...
const Process = (student_operation_log) => {
  ...
  // const start_time = new Date('2019-10-16T15:00:00');
  // const finish_time = new Date('2019-10-16T16:30:00');
...
const Boot = async () => {
  ...
  // let student_operation_log = await Query('select * from teacher_page_turning where url = "/documents/se4.pdf" and page_num > 0 order by id;', []);
